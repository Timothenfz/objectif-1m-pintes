export const BADGES = [
  ...
  { id: 'instigator',    cat: 'Soirée',    rarity: 'Rare',        icon: '🫵', name_fr: 'Instigateur',         name_en: 'Instigator',        desc_fr: 'Premier à poster dans la journée', desc_en: 'First to post of the day', check: (s) => s.firstOfDay >= 1 },
  { id: 'lundi_plaisir', cat: 'Heure',     rarity: 'Rare',        icon: '😈', name_fr: 'Lundi Plaisir',       name_en: 'Monday Pleasure',   desc_fr: 'Pinte entre 8h et 10h un lundi',   desc_en: 'Pint between 8am and 10am on a Monday', check: (s) => s.hasLundiPlaisir },
  { id: 'marathonien',   cat: 'Streak',    rarity: 'Épique',      icon: '🏃', name_fr: 'Marathonien',         name_en: 'Marathon Runner',   desc_fr: '42 pintes en une semaine',          desc_en: '42 pints in a week',        check: (s) => s.weekPintes >= 42 },
  { id: 'nucleaire',     cat: 'Soirée',    rarity: 'Rare',        icon: '☢️', name_fr: 'Nucléaire',           name_en: 'Nuclear',           desc_fr: '30 pintes en une semaine',          desc_en: '30 pints in a week',        check: (s) => s.weekPintes >= 30 },
