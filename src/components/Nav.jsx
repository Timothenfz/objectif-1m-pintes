...
const TABS = [
  ...
  { path: '/classement', label: 'Classement', icon: (a) => <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={a?2.5:1.8} strokeLinecap="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg> },
...
export default function Nav() {
  ...
  return (
    <>
      ...
      >
        <svg width="24" height="24" fill="none" stroke="#0d0d0d" strokeWidth="2.5" strokeLinecap="round" viewBox="0 0 24 24">
      ...
      <nav style={{
        ...
        <div style={{
          ...
          paddingRight: 70, // espace pour le bouton flottant
        }}>
          <style>{`
